...
CREATE TABLE social_accounts(
    id INT PRIMARY KEY AUTO_INCREMENT,
    provide VARCHAR(20) NOT NULL COMMENT 'Tên nhà mạng social',
    provide_id VARCHAR(50) NOT NULL,
    email VARCHAR(150) NOT NULL COMMENT 'Tên tài khoản email',
...
CREATE TABLE product_images(
    ...
    CONSTRAINT fk_product_images_product_id FOREIGN KEY (product_id) REFERENCES 
...
--trạng thái đơn hàng chỉ đc nhận 1 vài giá trị cụ thể
ALTER TABLE orders 
